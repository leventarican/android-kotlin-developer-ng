...
class Screen0Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // fragment extension function: set appbar title
        setTitle("# screen 0")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        // when data == max then navigate to next screen
        viewModel.data.observe(viewLifecycleOwner, Observer {
            Log.d("#", "data increased: $it")
            if (it == Screen0ViewModel.max) {
                Log.d("#", "max data reached. reset data.")
                viewModel.reset()

                // *Directions class is generated by (navigation) Safe Args plugin
